...
const Login = ()=>{
    ...
    const handleLogin = async ()=>{
        ...
        if (passwordError) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$toastify$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error(passwordError);
            return;
        }
        const usernameError = await validateUsername(username);
        if (usernameError) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$toastify$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error(usernameError);
            return;
        }
        setLoading(true);
        try {
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post(`${BACKEND_URL}/auth/login`, {
                username,
                password
            });
    ...
    const handleSignup = async ()=>{
        ...
        setLoading(true);
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post(`${BACKEND_URL}/auth/signup`, {
                username,
                password,
                email
            });
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$toastify$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].success("✅ Signup successful! Please check your email to confirm your account.");
            setIsLogin(true);
        } catch (err) {
            console.error("Signup error:", err.response?.data); // Log the full error response
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$toastify$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error(`❌ ${err.response?.data?.error || "An error occurred during signup"}`);
        } finally{
            setLoading(false);
        }
    };
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__d133fe._.js.map