...
const Home = () => {
  ...
  return (
    <div className="flex flex-col justify-center items-center min-h-screen bg-gradient-to-r from-green-600 via-green-700 to-trasnparent text-white px-6 py-12 relative overflow-hidden">
      ...
      <div className="absolute top-0 left-0 w-full h-full bg-cover bg-center opacity-40 animate-background" 
        style={{
          backgroundImage: 'url("https://images.unsplash.com/photo-1531415074968-036ba1b575da?q=80&w=2967&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D")'
        }}
      ></div>
